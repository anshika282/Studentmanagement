...
<div class="container-fluid">
  ...
  <li class="nav-item  ">
    <a href="student_attendance.php" class="nav-link fw-bold text-light bg-dark  fs-4" >  
...
<div class="panel panel-default px-5 ">
      ...
      <div class="panel-body py-4 ">
          <a href="homepg.php" class="btn btn-primary">Back</a>
          ...
          <table class="table">
              <thead>
                  ...
                  <?php
                       ...
                       $query="select distinct date from attendance where st_id in (select uid from student where sname='$s_name') ";
              ...
              <tr>
                       ...
                       <td><a  href="student_attview.php?date=<?php echo $val['date'];?>" class="btn btn-primary">View</a></td>
              </tr>
      <?php   }
                       }?>
    </div>
