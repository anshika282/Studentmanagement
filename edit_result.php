...
$sql="update result set marks='$mrks' where rid='$iid' ";
...
$ret = "SELECT student.sname,class.cstd,class.section from result join student on result.stuid=result.stuid join subject on subject.sbid=result.subid join class on class.cid=student.clid where student.uid='$stid' limit 1";
...
{  ?>
                                            ...
                                            <label for="default" class="col-sm-2 control-label">Class</label>
                                                        <div class="col-sm-10">
<?php echo $row['cstd']?>(<?php echo $row['section']?>)
                                                        </div>
                                                    </div>
<div class="form-group">
...
<?php 
$sql = "SELECT distinct student.sname,student.uid,class.cstd,class.section,subject.subjname,result.marks,result.rid as resultid from result join student on student.uid=result.stuid join subject on subject.sbid=result.subid join class on class.cid=student.clid where student.uid='$stid'";
...
<input type="text" name="marks[]" class="form-control" id="marks" value="<?php echo $result['marks']?>" maxlength="5" required="required" autocomplete="off">
</div>
</div>
